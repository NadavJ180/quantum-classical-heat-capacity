...
\begin{figure*}[!t]
\centering
\includegraphics[draft=false,width=0.7\textwidth]{fig_cv_benchmark_quantum_abs.png}
...
\begin{figure*}[!t]
\centering
\includegraphics[draft=false,width=0.7\textwidth]{fig_cv_benchmark_classical.png}
