...
\begin{equation}
\begin{aligned}
\frac{\partial\expval{E}}{\partial\beta} &= -\frac{1}{Z^2}\frac{\partial Z}{\partial\beta}\sum_n E_ne^{-\beta E_n} - \frac{1}{Z}\sum_n E_n^2 e^{-\beta E_n}\\
...
\begin{equation}
\begin{aligned}
C_v^{\text{HO}} &= k_B(\beta\hbar\omega)^2\frac{e^{\beta\hbar\omega}}{\left(e^{\beta\hbar\omega}-1\right)^2}\\
&= \frac14 k_B\left[\beta\hbar\omega\,\operatorname{csch}\!\left(\frac{\beta\hbar\omega}{2}\right)\right]^2,
\end{aligned}
\end{equation}
...
A. V. Oppenheim and R. W. Schafer, \emph{Discrete-Time Signal Processing}, 3rd ed. Upper Saddle River, NJ: Prentice Hall, 2010, ch. 4, ``Frequency-Domain Representation of Sampling,'' pp. 169--174.
